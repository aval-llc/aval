...
import type { AvalOneDefinition, DomainId, LeadDefinition } from "./types.ts";
...
/*
 * Where each domain applies, as rules over the workspace's operating profile
 * (lib/organizations/operating-profile.ts). A workspace that has said nothing
 * reaches every domain, and an axis it left empty never rules one out.
 */
const OPERATORS = ["property_management", "owner_operator"];
const RUNS_BUILDINGS = [...OPERATORS, "association_management", "real_estate_corporate", "asset_management"];
const LEASES_SPACE = [...OPERATORS, "brokerage_leasing", "asset_management"];
const RESIDENTIAL_ASSETS = ["multifamily", "single_family", "affordable", "student", "mixed_use"];
const RENTED_ASSETS = [...RESIDENTIAL_ASSETS, "commercial"];
const EVERYWHERE: EligibilityRule = {};
...
export const LEADS: readonly LeadDefinition[] = [
  {
    ...
    eligibility: { models: LEASES_SPACE, assets: RENTED_ASSETS },
  ...
  },
  {
    ...
    eligibility: { models: [...OPERATORS, "brokerage_leasing"], assets: RESIDENTIAL_ASSETS },
  ...
  },
  {
    ...
    eligibility: { models: OPERATORS, assets: RESIDENTIAL_ASSETS },
  ...
  },
  {
    ...
    eligibility: { models: [...OPERATORS, "asset_management"], assets: RENTED_ASSETS },
  ...
  },
  {
    ...
    eligibility: { models: RUNS_BUILDINGS },
  ...
  },
  {
    ...
    eligibility: { models: ["property_management", "association_management", "asset_management"] },
  ...
  },
  {
    ...
    eligibility: { models: [...LEASES_SPACE, "real_estate_corporate"], assets: RENTED_ASSETS },
  ...
  },
  {
    ...
    eligibility: { models: ["owner_operator", "asset_management", "real_estate_corporate", "property_management"] },
  ...
  },
  {
    ...
    eligibility: { models: ["association_management"], assets: ["association"], match: "any" },
  ...
  },
  {
    ...
    eligibility: { assets: ["commercial", "mixed_use"] },
