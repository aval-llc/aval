    ...
    schema: {
      ...
      input_schema: {
        ...
        properties: {
          ...
          currency: { type: "string", enum: ["USD", "MXN"], description: "ISO-4217 code of the lease ledger. Must be a currency the workspace financial policy allows." },
          installments: { type: "integer", minimum: 1, maximum: 60 },
          first_due_date: text(10),
          note: { type: "string", maxLength: 2000 },
        },
        required: ["provider", "lease_id", "total_minor", "currency", "installments", "first_due_date"],
      },
    },
    payload: (args) => compact({
  ...
  },
  {
    schema: {
      ...
      input_schema: {
        ...
        required: ["provider", "lease_id", "amount_minor", "currency", "received_on"],
      },
    },
    payload: (args) => compact({
      leaseId: str(args.lease_id),
