 ...
 */
export const pmsWriteAuthorizations = pgTable(
  "pms_write_authorizations",
  {
    ...
    signedAuthorization: boolean("signed_authorization").notNull().default(false),
 ...
 */
export const pmsActionFlows = pgTable(
  "pms_action_flows",
  {
    id: text("id").primaryKey(),
    /**
 ...
 */
export const pmsWriteQueue = pgTable(
  "pms_write_queue",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id").notNull().references(() => organizations.id),
...
export const agentDeployments = pgTable(
  "agent_deployments",
  {
    ...
    workflowsJson: jsonText("workflows_json").notNull().default("[]"),
 ...
 */
export const organizationSeatSlugs = pgTable(
 ...
 */
export const pmsSeatSenders = pgTable(
  "pms_seat_senders",
  {
    organizationId: text("organization_id").notNull().references(() => organizations.id),
 ...
 */
export const pmsSeatMessages = pgTable(
  "pms_seat_messages",
  {
    /**
...
export const attemptPolicies = pgTable(
  "attempt_policies",
  {
    ...
    backoffFactor: doublePrecision("backoff_factor").notNull().default(2),
 ...
 */
export const workAttempts = pgTable(
  "work_attempts",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id").notNull().references(() => organizations.id),
    ...
    actionsJson: jsonText("actions_json").notNull().default("[]"),
    toolsJson: jsonText("tools_json").notNull().default("[]"),
    delegationsJson: jsonText("delegations_json").notNull().default("[]"),
    ...
    progressed: boolean("progressed").notNull().default(false),
    ...
    externalEffectsJson: jsonText("external_effects_json").notNull().default("[]"),
    createdAt: timestamp("created_at", { withTimezone: true, mode: "date" }).notNull(),
  },
  (table) => [
 ...
 */
export const expertiseProfiles = pgTable(
  "expertise_profiles",
  {
    id: text("id").primaryKey(),
    ...
    capabilityTagsJson: jsonText("capability_tags_json").notNull().default("[]"),
    /** Business domains it belongs to, as a JSON string array. */
    domainsJson: jsonText("domains_json").notNull().default("[]"),
    /** Words and work types that suggest it, as a JSON string array. */
    routingSignalsJson: jsonText("routing_signals_json").notNull().default("[]"),
    /** Tools it cannot work without, as a JSON string array. Absence of one excludes it. */
    requiredCapabilitiesJson: jsonText("required_capabilities_json").notNull().default("[]"),
 ...
 */
export const employeeExpertise = pgTable(
  "employee_expertise",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id").notNull().references(() => organizations.id),
 ...
 * anything.
 */
export const expertiseSelections = pgTable(
  "expertise_selections",
  {
    ...
    candidatesJson: jsonText("candidates_json").notNull().default("[]"),
    /** The slugs actually loaded, as a JSON string array. */
    selectedJson: jsonText("selected_json").notNull().default("[]"),
